...
Command: npx gltfjsx@6.5.3 robo.glb --transform 
Files: robo.glb [296.96KB] > C:\mern stack\portfolio\3d-portfolio\public\models\robo-transformed.glb [67.82KB] (77%)
...
export function Robo(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/models/robo-transformed.glb')
...
useGLTF.preload('/models/robo-transformed.glb')
